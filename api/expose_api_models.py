...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.CustomerContact, method_decorators= method_decorators)
    api.expose_object(database.models.SalesRep, method_decorators= method_decorators)
