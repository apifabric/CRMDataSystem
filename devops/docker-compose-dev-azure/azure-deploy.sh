...
resourcename="crmdatasystem"  # lower case, only
resourcegroup="crmdatasystem_rg"
...
# git clone https://github.com/apilogicserver/crmdatasystem.git
# cd crmdatasystem
...
az group create --name crmdatasystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group crmdatasystem_rg --sku S1 --is-linux
az container create --resource-group crmdatasystem_rg --name crmdatasystem --image apilogicserver/crmdatasystem:latest --dns-name-label crmdatasystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//crmdatasystem.westus.azurecontainer.io:5656'
